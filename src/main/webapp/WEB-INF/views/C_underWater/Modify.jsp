		...
		$(document).ready(function() {
			...
			$(".Modify_btn").click(function() {
				...
				if($("#title").val() == "") {
					...
					$("#mform").attr("action", "${contextPath}/underWaterBoard/Modifyinsert");
					$("#mform").submit();
				}
			});
	    	...
	    	$(".back_btn").click(function() {
	    		location.href="${contextPath}/underWaterBoard/modiFyCancle?num="+${modifyList.num};
				});
		});
	</script>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">수중 갤러리 글 수정</h4>
