		...
		$(document).ready(function() {
			...
			$(".wrt_btn").click(function() {
				...
				if($("#title").val() == "") {
					...
					$("#wform").attr("action", "${contextPath}/reviewBoard/writeinsert");
					$("#wform").submit();
				}
			});
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">후기 게시판 글 작성</h4>
                ...
                <form class="form" role="form" id="wform" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                  	...
                  	<h5><b>제목</b></h5>
                    <input class="form-control input-lg" name="title" type="text" id="title" placeholder="제목을 입력하세요(30자 이내)"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                  	<h5><b>한줄 소개</b></h5>
                    <input class="form-control" id="introduction" name="introduction" type="text" placeholder="소개글을 50자 이내로 등록해주세요"/>
                  </div>
