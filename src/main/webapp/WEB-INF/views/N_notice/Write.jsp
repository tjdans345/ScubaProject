...
$(document).ready(function(){
	$("#wrbtn").click(function() {
		...
		if($("#title").val() == "") {
			...
			$("#wform").attr("action", "${contextPath}/Notice/writeinsert");
			$("#wform").submit();
		}
	});
	//돌아가기 버튼
	$(".back_btn").click(function() {
		location.href="${contextPath}/Notice/moveNoticeList";
	});
});
</script>	
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h4 class="font-alt mb-0">공지사항 글 작성</h4>
                <hr class="divider-w mt-10 mb-20">
                <form class="form" role="form" id="wform" method="post" action="">
                  ...
                  <button class="btn btn-border-d btn-round" id="wrbtn" type="button">글쓰기</button>
