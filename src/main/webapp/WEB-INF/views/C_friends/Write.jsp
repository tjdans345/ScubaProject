		...
		$(document).ready(function() {
			...
			$(".wrt_btn").click(function() {
				...
				if($("#title").val() == "") {
					...
					$("#wform").attr("action", "${contextPath}/friendsBoard/WriteInsert");
					$("#wform").submit();
				}
			});
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form id="wform" class="form" role="form" method="post">
                  ...
                  <div class="form-group">
                  	<h5><b>인사말</b></h5>
                  <textarea class="form-control" id="introduction" name="introduction" rows="2" placeholder="인사말" style="resize: none;"></textarea>
                  </div>
                  <div class="form-group">
                  	<h5><b>신청방법</b></h5>
                  <textarea class="form-control" id="appmethod" name="appmethod" rows="2" placeholder="신청방법" style="resize: none;"></textarea>
                  </div>
                  <div class="form-group">
                  	<h5><b>여행 계획</b></h5>
                    <input class="form-control input-lg" id="state" name="state" type="text" placeholder="목적지"/>
                  <div class="input-group" style="float: left; width: 50%;">
                    <div class="input-group-addon">출발일</div>
                    <input class="form-control input-lg" id="startdate" value="" name="startdate" type="date" name="date" placeholder="출발일"/>
                  </div>
                  <div class="input-group" style="float: left; width: 50%;">
                    <div class="input-group-addon">도착일</div>
                    <input class="form-control input-lg" id="enddate" name="enddate" type="date" name="date" placeholder="도착일"/>
                  </div>
                  </div>
                  <div class="form-group">
                  	<h5><b>모집 인원</b></h5>
                    <input class="form-control input-lg" id="membercount" name="membercount" type="text" placeholder="총 인원" style="width: 50%; float: left;"/>
                    <input class="form-control input-lg" id="nowcount" name="nowcount" type="text" placeholder="현재 인원" style="width: 50%; float: left;"/>
                  </div>
                  <div class="form-group" style="clear: both; padding-top: 5px;">
                  	<h5><b>연락처</b></h5>
                    <input class="form-control input-lg" id="phone" name="phone" type="text" placeholder="휴대폰번호" style="width: 50%; float: left;"/>
                    <input class="form-control input-lg" id="kakao" name="kakao" type="text" placeholder="카카오톡" style="width: 50%; float: left;"/>
                  </div>
