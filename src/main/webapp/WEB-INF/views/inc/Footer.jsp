...
<body>
		<div class="module-small bg-dark" style="padding:20px 0; background-color: #333;">
          <div class="container">
            <div class="row">
              <div class="col-sm-3">
                <div class="widget">
        ...
        <footer class="footer bg-dark" style="background-color: #252525;">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2020&nbsp;<a href="index.html">Time To will Be Star</a>, MoonyHoony</p>
              </div>
              <div class="col-sm-6">
